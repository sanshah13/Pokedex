...
public class MovesListBaseAdapter2 extends BaseAdapter {
	private static String[] movesList;
	private LayoutInflater mInflater;
	
	public MovesListBaseAdapter2(Context context, String[] results){
		movesList = results;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null)
		{
			convertView = mInflater.inflate(R.layout.custom_moves_view, null);
